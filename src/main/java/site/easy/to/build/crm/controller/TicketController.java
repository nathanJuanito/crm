...
public class TicketController {
    ...
    public String createTicket(@ModelAttribute("ticket") @Validated Ticket ticket,
        ...
        if (montant != null && montant.compareTo(BigDecimal.ZERO) > 0 && confirmBudgetOverrun == null) {
            ...
            BigDecimal budgetTotal = customerRepository.getTotalBudgetByCustomerId(customerId);
            ...
            if (budgetTotal != null && budgetTotal.compareTo(BigDecimal.ZERO) > 0) {
                ...
                if (budgetDepasse) {
                    ...
                    return "common/budget-confirmation";
                }
            }
        }        
        ...
        if(bindingResult.hasErrors()) {
            // Code existant...
            System.out.println("Erreurs de validation, retour au formulaire");
            return "ticket/create-ticket";
        }
        ...
        if (montant != null && montant.compareTo(BigDecimal.ZERO) > 0) {
            ...
            if (budgetTotal != null && budgetTotal.compareTo(BigDecimal.ZERO) > 0) {
                ...
                if (seuilDepasse) {
                    ...
                    // Afficher tous les attributs flash
                    System.out.println("Attributs flash: " + redirectAttributes.getFlashAttributes());
                }
            }
        }
        ...
        if (montant != null && montant.compareTo(BigDecimal.ZERO) > 0) {
            Depense depense = depenseService.createDepenseForTicket(savedTicket, montant);
